...
public class MiniProj1  {
    ...
    private static boolean isIdExists(String id) throws SQLException {
    ...
    private static void recordLogin(String id) throws SQLException {
    ...
    private static void recordLogout(String id) throws SQLException {
    ...
    private static void viewMyInfo(String id) throws SQLException {
    ...
    private static void viewPostList(String userId) {
        try {
            int page = 1;
            while (true) {
                displayPosts(page);
    ...
    private static void displayPosts(int page) throws SQLException {
    ...
    private static void viewPostDetail(int postId, String userId) throws SQLException {
    ...
    private static void updatePostViews(int postId) throws SQLException {
    ...
    private static void updatePost(int postId) throws SQLException {
    ...
    private static void deletePost(int postId) throws SQLException {
        System.out.print("비밀번호 확인: ");
        String password = scanner.nextLine();
    ...
    private static void createPost(String userId) throws SQLException {
